...
public class ArticleBean {
	...
	private List<com.keephealth.app.entity.TagBean> tagBeans; // 文章搜索标签集合
	private com.keephealth.app.entity.AuthorBean authorBean; // 文章作者信息
	...
	public ArticleBean(String title, String datetime, String datetext,
			String context, String headImage, List<com.keephealth.app.entity.TagBean> tagBeans,
                       com.keephealth.app.entity.AuthorBean authorBean) {
		super();
		this.title = title;
	...
	public List<com.keephealth.app.entity.TagBean> getTagBeans() {
		return tagBeans;
	}

	public void setTagBeans(List<com.keephealth.app.entity.TagBean> tagBeans) {
		this.tagBeans = tagBeans;
	}
