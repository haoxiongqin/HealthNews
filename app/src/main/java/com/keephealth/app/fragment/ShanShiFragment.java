 ...
 * author:悟.静
 */
public class ShanShiFragment  extends BaseFragment implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener,DefineView {
    ...
    public static ShanShiFragment newInstance(CategoriesBean extra){
        Bundle bundle=new Bundle();
        bundle.putSerializable(KEY,extra);
        ShanShiFragment fragment=new ShanShiFragment();
    ...
    public void initValidata() {
        String url=categoriesBean.getHref()+"yangsheng471"+page+".shtml";
