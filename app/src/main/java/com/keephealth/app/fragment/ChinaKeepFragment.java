...
public class ChinaKeepFragment extends Fragment implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener,DefineView {
    ...
    public void initValidata() {
        String url=Config.LZYYSW+"/yangsheng/list/0/"+page;
