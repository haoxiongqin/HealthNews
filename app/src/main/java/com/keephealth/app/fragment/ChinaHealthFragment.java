...
public class ChinaHealthFragment extends Fragment implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener,DefineView {
    ...
    public void initValidata() {
        String url= Config.LZYYSW+"/baojian/list/0/"+page;
