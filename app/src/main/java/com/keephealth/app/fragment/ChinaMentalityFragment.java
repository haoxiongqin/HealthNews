...
public class ChinaMentalityFragment extends Fragment implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener,DefineView {
    ...
    public void initValidata() {
        String url= Config.LZYYSW+"/xinli/list/0/"+page;
